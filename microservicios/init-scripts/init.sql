...
-- ============================================
-- MIGRACIÓN: columna area_m2 en cultivos (idempotente)
-- ============================================
ALTER TABLE cultivos ADD COLUMN IF NOT EXISTS area_m2 NUMERIC(10,2) NOT NULL DEFAULT 0 CHECK (area_m2 >= 0);
