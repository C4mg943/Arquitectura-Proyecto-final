...
export interface FincaAreaUsageDto {
  fincaId: number
  totalHa: number
  ocupadoHa: number
  disponibleHa: number
...
export interface ParcelaAreaUsageDto {
  parcelaId: number
  hectareas: number
  totalM2: number
  ocupadoM2: number
...
export const apiClient = {
  ...
  parcelas: {
    ...
    areaUsage: (id: number) => apiClient.get<ParcelaAreaUsageDto>(`/api/parcelas/parcela/${id}/area-usage`),
  },
  ...
  fincas: {
    ...
    areaUsage: (id: number) => apiClient.get<FincaAreaUsageDto>(`/api/fincas/finca/${id}/area-usage`),
  },
